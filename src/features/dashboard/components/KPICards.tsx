...
export function KPICards() {
  const kpis = [
    ...
    { title: "Today's Emissions", value: "42.5", unit: "tons", trend: "1.1% vs Avg", TrendIcon: ArrowUp, trendColor: "text-status-warning", Icon: Calendar, showSpark: true },
    { title: "This Month", value: "856.2", unit: "tons", trend: "On Track", TrendIcon: CheckCircle, trendColor: "text-status-success", Icon: Calendar, showProgress: true, progress: 50 },
