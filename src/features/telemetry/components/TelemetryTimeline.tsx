  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 h-24 bg-surface-container-lowest/95 backdrop-blur-md border-t border-outline-variant px-6 py-3 flex flex-col justify-center">
      <div className="flex justify-between items-center mb-2">
        <span className="text-xs text-on-surface-variant font-bold uppercase">Route Timeline: VH-8842-X</span>
        <span className="font-mono text-xs text-outline">Today, 08:00 - Present</span>
      </div>
      ...
      <div className="flex justify-between mt-1 px-1">
        ...
        <span className="text-[10px] text-outline">12:00 PM</span>
        <span className="text-[10px] text-primary font-medium">Current (01:15 PM)</span>
      </div>
    </div>
  );
}
