      ...
      <div className="p-container-padding border-b border-outline-variant bg-surface-bright sticky top-0 z-10">
        <div className="flex justify-between items-start mb-2">
          <div>
            ...
            <div className="text-body-md text-on-surface-variant mt-1 flex items-center gap-1">
              <Icon name="attachment" className="w-4 h-4" />
              <span>Driver: John Doe</span>
            </div>
          </div>
          <ObjectStatus state="Critical" className="text-label-sm">
            IDLING
          </ObjectStatus>
        </div>
      </div>
      ...
      <div className="p-container-padding grid grid-cols-2 gap-card-gap">
        <div className="bg-surface rounded-xl p-4 border border-outline-variant/50">
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-headline-md text-on-surface">0</span>
            <span className="text-body-md text-on-surface-variant">km/h</span>
          </div>
        </div>
        ...
        <div className="bg-error-container/30 rounded-xl p-4 border border-error/20">
          <div className="flex items-center gap-2 mb-1">
            ...
            <Label className="text-label-sm text-error">Est. Carbon</Label>
          </div>
          <div className="flex items-baseline gap-1">
            <span className="text-headline-md text-error">380</span>
            <span className="text-body-md text-error">kg</span>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div>
            <div className="flex justify-between mb-2">
              ...
              <span className="tabular-nums text-body-md font-medium text-on-surface">
                210 kg
              </span>
            </div>
          ...
          <div>
            <div className="flex justify-between mb-2">
              <span className="text-label-sm text-on-surface-variant flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded-sm bg-error inline-block"></span>{" "}
                Idling (Waste)
              </span>
              <span className="tabular-nums text-body-md font-semibold text-error">
                170 kg
              </span>
            </div>
            <ProgressIndicator
          ...
          <div className="mt-2 pt-5 border-t border-outline-variant/50 flex items-start gap-3">
            ...
            <p className="text-body-md leading-snug text-on-surface-variant">
              Vehicle has been idling for{" "}
              <span className="font-bold text-on-surface">45 minutes</span> at
              current location, generating excess emissions.
            </p>
          </div>
        </div>
      </div>
