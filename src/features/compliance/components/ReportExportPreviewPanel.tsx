    ...
    <section className="flex h-full flex-col overflow-hidden rounded-xl border border-outline-variant bg-surface-container-lowest shadow-sm">
      ...
      <div className="flex flex-1 flex-col gap-6 overflow-y-auto bg-surface-container-low p-4">
        <div className="relative aspect-[1/1.4] w-full overflow-hidden rounded-lg border border-outline-variant bg-white shadow-sm">
          ...
          />
          <div className="absolute left-3 top-3 rounded-full border border-status-success/20 bg-white/90 px-2 py-1 text-xs font-semibold text-status-success shadow-sm">
            Ready to Export
          </div>
        </div>
          ...
          <div className="flex overflow-hidden rounded-md border border-primary">
            {formatOptions.map((format) => (
              ...
              >
                ...
                />
                <span className="block px-3 py-1.5 text-center text-sm font-semibold text-primary transition-colors peer-checked:bg-primary peer-checked:text-white">
                  {format.label}
                </span>
              </label>
            ))}
      ...
      <div className="flex flex-col gap-2 border-t border-outline-variant bg-white p-4">
        <button
          type="button"
          className="h-9 rounded-md bg-primary text-sm font-semibold text-white shadow-sm transition-colors hover:bg-primary-container"
        >
          Generate Report
        </button>
