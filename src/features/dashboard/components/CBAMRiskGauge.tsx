        ...
        <div className="flex-1 space-y-6 w-full">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-surface-container-low p-3 rounded border border-outline-variant/50">
              <p className="text-xs font-semibold text-on-surface-variant mb-1">Projected Monthly</p>
              <p className="text-base font-bold text-on-surface">€ 5,800</p>
            </div>
            <div className="bg-surface-container-low p-3 rounded border border-outline-variant/50">
              <p className="text-xs font-semibold text-on-surface-variant mb-1">Projected Yearly</p>
